...
//                 : 0.0),
//             rating: (json['rating'] is num ? json['rating'].toDouble() : 0.0), // റേറ്റിംഗ് ഡബിൾ ആക്കാം
...
// class Review {
//   // റിവ്യൂ റേറ്റിംഗ് int ആയി വരാനും സാധ്യതയുണ്ട്, അല്ലെങ്കിൽ double ആയിട്ടും.
//   // API അനുസരിച്ച് ഇവിടെ `num` ഉപയോഗിക്കുന്നത് കൂടുതൽ സുരക്ഷിതമായിരിക്കും
//   // എന്നിട്ട് ആവശ്യത്തിനനുസരിച്ച് toInt() അല്ലെങ്കിൽ toDouble() ഉപയോഗിക്കുക.
//   // ഇവിടെ int തന്നെ മതി, DummyJSON Review Rating integer ആയിട്ടാണ് തരുന്നത്.
//   final int rating;
...
//     return Review(
//       rating: json['rating'] is int ? json['rating'] : 0, // int ആയി കാസ്റ്റ് ചെയ്യുന്നു.
